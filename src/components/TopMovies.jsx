  ...
  return (
    <div className=" ">
      <div className="container mx-auto ">
        <h2 className=" text-center text-3xl md:text-4xl my-10">
          Top 5 Movies
        </h2>
        <div className="grid grid-cols-3 px-28 md:px-32 pt-5 md:pt-10">
          ...
          <div data-aos="fade-right" className="col-span-2 ">
            <img
              className="w-full h-full"
              src="https://wallpapers.com/images/hd/movie-poster-background-x6fu97aioeo5vidk.jpg"
              alt=""
            />
          </div>
          ...
          <div data-aos="fade-left">
            <img
              className="w-full h-full"
              src="https://w0.peakpx.com/wallpaper/902/32/HD-wallpaper-heimdall-thor-comics-holi-hollywood-idris-elba-marvel-marvel-cinematic-universe-marvel-comics-marvel-movies-movie-movie-poster-orange-poster-thor-ragnarok.jpg"
              alt=""
            />
          </div>
        </div>
