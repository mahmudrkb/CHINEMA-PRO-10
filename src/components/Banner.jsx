...
const Banner = () => {
  return (
    <div className=" mt-16  mb-5 mx-auto   pb-5">
      <div className="carousel mt-2 w-full ">
        <div id="item1" className="carousel-item relative w-full">
          <img
            src="https://www.hindustantimes.com/ht-img/img/2024/12/04/550x309/pushpa_2_allu_arjun_1733330413064_1733330427379.jpeg"
          ...
          <div className="absolute left-5 right-5 top-1/2 flex -translate-y-1/2 transform justify-between ">
            <div>
              ...
              <Link className=" btn bg-transparent text-white bg-slate-400 border-none ">
                See More
              </Link>
            </div>
          </div>
